...
export default function Contact() {
    ...
    const [isVisibleS1, setIsVisibleS1] = useState(false);
  ...
  return (
    <div>
     <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
            <div  id="s1" ref={s1Ref} className={`text-center px-6 ${isVisibleS1 ? 'animate-fade-up animate-once' : 'opacity-0 translate-y-10'}`} >
                <h1 className="text-gray-800 font-normal text-4xl font-serif text-center ">Contact Us</h1>
                <p className=" text-gray-500 text-base pt-3 font-thin leading-normal"  >
                Get in touch with us for any inquiries, support, or feedback. <br></br> We re here to help and would love to hear from you!
                    </p>
            </div>

            <div className="grid  lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">

                <div className="bg-[#133d53]  rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <form>
                        <div className="grid sm:grid-cols-2 gap-8">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <g clipPath="url(#)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
                                    <path
                                    fill="none"
                                    strokeMiterlimit="10"
                                    strokeWidth="40"
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    <div className="flex items-center">
                                        <input id="radio1" type="radio" name="value" className="hidden peer"  />
                                    ...
                                    <div className="flex items-center">
                                        <input id="radio2" type="radio" name="value" className="hidden peer" />
                                    ...
                                    <div className="flex items-center">
                                        <input id="radio3" type="radio" name="value" className="hidden peer" />
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-gray-900 hover:bg-blue-700">
